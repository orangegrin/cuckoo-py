...
from MA_calc import get_rnn_sample_data
# 训练数据个数
...
sample_data = [ i*100 for i in get_rnn_sample_data()]
print(sample_data[:50])
train_x, train_y = generate_data( sample_data[:test_start] )
test_x, test_y = generate_data( sample_data[test_start:test_end] )
